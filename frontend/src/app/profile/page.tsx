            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                <h4 className="font-semibold text-black dark:text-white">
                  About Dr. Stephen Conley (he/him)
                </h4>
                <p className="mt-4.5">
                  Dr. Stephen Conley is a distinguished cardiologist known for his expertise in diagnosing and treating heart conditions. With extensive experience in both clinical practice and research, Dr. Conley has dedicated his career to advancing cardiovascular health and patient care. He holds a medical degree from a prestigious institution and has completed rigorous training in cardiology. Dr. Conley is highly regarded for his compassionate approach to patient care and his commitment to staying at the forefront of cardiological advancements. He actively participates in medical conferences and contributes to scholarly publications, continually enhancing his knowledge and skills to provide the best possible care for his patients.
                </p>
              </div>
